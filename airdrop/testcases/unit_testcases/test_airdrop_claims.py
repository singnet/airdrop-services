...
class AirdropClaims(TestCase):
    ...
    @patch('airdrop.infrastructure.repositories.airdrop_repository.AirdropRepository.get_airdrop_window_claimable_amount')
    @patch('airdrop.infrastructure.repositories.airdrop_repository.AirdropRepository.is_claimed_airdrop_window')
    def test_airdrop_get_stake_claim_details_failure_case(self, mock_is_claimed_airdrop_window, mock_get_airdrop_window_claimable_amount, mock_get_signature_for_airdrop_window_id, mock_check_rewards_awarded, mock_recover_address):
    ...
    @patch('airdrop.infrastructure.repositories.airdrop_repository.AirdropRepository.get_airdrop_window_claimable_amount')
    @patch('airdrop.infrastructure.repositories.airdrop_repository.AirdropRepository.is_claimed_airdrop_window')
    def test_airdrop_get_stake_claim_details_(self, mock_is_claimed_airdrop_window, mock_get_airdrop_window_claimable_amount, mock_get_signature_for_airdrop_window_id, mock_check_rewards_awarded, mock_recover_address):
        ...
        mock_check_rewards_awarded.value = True, 1000
        payload = {
            "address": "0xEA674fdDe714fd979de3EdF0F56AA9716B898ec1"
        }
