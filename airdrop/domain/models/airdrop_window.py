...
class AirdropWindow:
    def __init__(self, airdrop_id, window_id, window_name,  description, registration_start_period, registration_end_period, total_airdrop_tokens, airdrop_window_rules, airdrop_window_timeline):
        ...
        self._airdrop_window_rules = airdrop_window_rules
    ...
    def get_airdrop_window_rules(self):
        return [
            ...
            for rule in self._airdrop_window_rules
        ]
    ...
    def to_dict(self):
        return {
            ...
            "airdrop_window_rules": self.get_airdrop_window_rules(),
